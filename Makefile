...
# /usr/bin/make pack     # xmp-pc98-1.0.32.zip
...
pack: dll
	...
	rm -f $(DIST)/xmp-pc98-1.0.32.zip
	python3 -c "import zipfile; from pathlib import Path; d=Path('$(DIST)'); z=d/'xmp-pc98-1.0.32.zip'; \
